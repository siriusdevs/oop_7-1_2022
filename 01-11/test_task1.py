...
check_triangle_perimeter = [(3, 4, 5, 12), (13, 20, 15, 48), (3.45, 4.53, 5.34, 13.32)]


@pytest.mark.parametrize('side1, side2, side3, back', check_triangle_perimeter)
...
check_triangle_area = [(3, 4, 5, 6), (13, 20, 15, 97.49), (3.45, 4.53, 5.34, 7.75)]
...
check_circle_area = [(5, 78.54), (4.4, 60.82), (200, 125663.71)]


@pytest.mark.parametrize('radius, back', check_circle_area)
